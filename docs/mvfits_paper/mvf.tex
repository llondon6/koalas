...
\begin{algorithm}[H]
  ...
  \begin{algorithmic}[1]
    ...
    \State Calculate the model representation error, e.g.: $\epsilon = ||\hatU \vecmu - \vec{f}||/||\vec{f}||$, where $var$ is the variance of the respective list.
    \vskip 10pt
...
\label{results}
%
\par We briefly review the application of \gmvr{} to a toy problem.
%
% Cross validation and removal of the last added basis symbol are used to assess model accuracy.
%
% \par
%
We then present the application of \gmvp{} and \gmvr{} to the respective modeling of \qnm{} frequencies, and harmonic mixing coefficients.
%
