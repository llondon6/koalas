...
\begin{abstract}
  ...
  %
  GMVR is a quasi-linear numerical method for interpolating rational functions. It therefore represents a solution to Runge's phenomenon.
	%
\end{abstract}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
Only where $\jf \cw\lmn=0$ does $_{-2}S\lmn( 0,\theta,\phi) = {_{-2}}Y_{\ell m}\theta,\phi)$, which makes equating the spherical and spheroidal harmonics approximate at best for general values of $\jf \cw\lmn$.
%
The consequences of that choice, in particular the mixing between spherical and spheroidal harmonics, are discussed in reference \cite{London:2014cma,London:2018gaq}.
%
...
%
With this in mind, here, we will develop algorithms for the linear (polynomial and rational) modeling of scalar functions (real or complex valued) of many variables.
%
