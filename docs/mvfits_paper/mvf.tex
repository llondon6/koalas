...
%
This approximation also applies to many of the so-called \textit{Phenom} models, where the frequency domain multipoles, $\tilde{h}\LM(f)$, are constructed such that their high frequency behavior is consistent with \eqn{hrd} in the time domain \cite{Hannam:2013oca,London:2017bcn,Khan:2015jqa,Schmidt:2014iyl}.
%
