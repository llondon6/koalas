...
%
\par \fig{fig:qnms} displays select training points, as well as model fits for $\cw\lmn$'s real and imaginary parts.
%
...
\end{widetext}
%
\par In each panel of \fig{fig:qnms}, the horizontal upper and lower demonstrate the effect of mapping $\jf$ onto $\kappa$.
%
...
%
\par Lastly, \fig{fig:qnm_err} shows residual errors.
%
...
%
\par Together, \eqns{eq:cw_fit_1}{eq:cw_fit_9} along with Figures (\ref{fig:qnms})-(\ref{fig:qnm_err}) present precise and accurate fits for the real and imaginary parts of \qnm{} frequencies for gravitational perturbations of Kerr \qnm{s}.
%
...
%
\fig{fig:ys} display comparisons of the fits with training data as well as related residuals.
%
...
%
As with the \qnm{} frequencies, residuals are dominated by small scale oscillations with amplitudes that are fractions of a percent.
