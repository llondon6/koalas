...
%
In the \eob{} formalism, $h\LM$ is modeled such that, after its peak (near merger), the effective functional form reduces (asymptotically) to \eqn{hrd}'s second line \cite{Pan:2013rra, Bohe:2016gbl, Nagar:2018zoe}.
%
