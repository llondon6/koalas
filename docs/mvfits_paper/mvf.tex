...
%
We note that, in the asymptotic vicinity of $\jf=1$, the \qnm{} frequencies and decay times are known to have solutions that are asymptoticly degenerate \cite{Yang:2012pj,Zimmerman:2015trm}.
%
{\scriptsize
\begin{algorithm}[H]
  %
