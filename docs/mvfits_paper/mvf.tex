...
%
\par While it is possible to enforce extremal Kerr conditions $\sigma_{\LMlmn}$, we find it effective to first use \gmvr{} to determine a functional form that works for all $\sigma_{\LMlmn}$, and then apply this form to the modeling of all $\sigma_{\LMlmn}$.
%
\par \eqns{eq:ys22220}{eq:ys55550} ...
